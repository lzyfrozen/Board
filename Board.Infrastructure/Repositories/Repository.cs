...
namespace Board.Infrastructure
{
    ...
    public class Repository<T> : IRepository<T> where T : class, IEntity
    {
        ...
        /// <returns></returns>
        public dynamic ExecuteScalar(string sql, object? param = null, CommandType? commandType = null)
        {
            var r = _unitOfWork.DbConnection.ExecuteScalar<dynamic>(sql, param: param, transaction: _unitOfWork.DbTransaction, commandType: commandType);
            return r;
        }
        ...
        /// <returns></returns>
        public PagedResult<T> GetPageList(string tableSql, string fields, int pageIndex, int pageSize, string? condition = null, string? orderBy = null, object? param = null)
        {
            var pagingResult = _unitOfWork.DbConnection.GetPageList<T>(tableSql, fields, pageIndex, pageSize, condition, orderBy, param: param, transaction: _unitOfWork.DbTransaction);
            return pagingResult;
        }
    }
}
